...
(defstruct (widget (:include placeholder)
  ...
  (on-drag-enter nil :type (or null (function (ui widget single-float single-float) (values boolean &optional))))
  (on-drag-move nil :type (or null (function (ui widget single-float single-float) (values boolean &optional))))
